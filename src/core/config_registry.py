...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DAILY_RUN_SOFT_TIMEOUT_SECONDS": {
        "title": "Daily Run Soft Timeout",
        "description": "Soft wall-clock budget in seconds for a full daily run. Set to 0 to disable.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "DAILY_RUN_SOFT_TIMEOUT_GRACE_SECONDS": {
        "title": "Daily Run Soft Timeout Grace",
        "description": "Reserve this many seconds before the deadline to stop starting new heavy work.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
